//Process Seven - Behaves as Outgoing Bay Two. Using actuators, it checks what the level of the truck is. If full, it states it's full and ready to depart.
...
ActuatorSetName(5, "Truck Five Status");
ActuatorSetName(8, "Product B Status");
